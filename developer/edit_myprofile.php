...
<?php
  session_start();
  $id = $_SESSION["id"];
  //get the user_tbl data to edit my profile data
...
<div class="container shivraj" >
  ...
  <form  action="myprofile_update_save.php" method="POST">
  <div class="row">
    <div class="col-md-4" style="border:5px green solid; padding-bottom:20px; padding:19px;margin-top:30px;margin-left: 97px;">  
      ...
      <input type="text" class="form-control" name="mobile" value="<?php echo $row[3]; ?>">
      
       <button style="color: white; background-color: green; margin-left: 81px; margin-top: 30px;">Save</button>
    </div>
<br>
